...
namespace BookShop.DAL
{
	...
	public partial class PublishersDAL
	{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(BookShop.Model.Publishers model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public BookShop.Model.Publishers DataRowToModel(DataRow row)
		{
			BookShop.Model.Publishers model=new BookShop.Model.Publishers();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Publishers T ");
