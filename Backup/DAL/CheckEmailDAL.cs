...
namespace BookShop.DAL
{
	...
	public partial class CheckEmailDAL
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "CheckEmail"); 
		}
		...
		public BookShop.Model.CheckEmail GetModel(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,Actived,ActiveCode from CheckEmail ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
			...
			BookShop.Model.CheckEmail model=new BookShop.Model.CheckEmail();
		...
		/// 得到一个对象实体
		/// </summary>
		public BookShop.Model.CheckEmail DataRowToModel(DataRow row)
		{
			BookShop.Model.CheckEmail model=new BookShop.Model.CheckEmail();
			if (row != null)
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,Actived,ActiveCode ");
			strSql.Append(" FROM CheckEmail ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from CheckEmail T ");
