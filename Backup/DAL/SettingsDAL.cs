...
namespace BookShop.DAL
{
	...
	public partial class SettingsDAL
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "Settings"); 
		}
		...
		/// 得到一个对象实体
		/// </summary>
		public BookShop.Model.Settings DataRowToModel(DataRow row)
		{
			BookShop.Model.Settings model=new BookShop.Model.Settings();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Settings T ");
