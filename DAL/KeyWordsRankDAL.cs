    ...
    public partial class KeyWordsRankDAL
    {
        ...
        public bool Add(BookShop.Model.KeyWordsRank model)
        {
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@SearchTimes", SqlDbType.Int,4)};
        ...
        public void AddBySearchDetails()
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into KeyWordsRank(");
            strSql.Append("KeyWords,SearchTimes)");
            strSql.Append(" select KeyWords,count(*) from SearchDetails where DateDiff(day,DateTime,getdate())<=7 group by KeyWords");
        ...
        public bool Update(BookShop.Model.KeyWordsRank model)
        {
            ...
            strSql.Append("SearchTimes=@SearchTimes");
            strSql.Append(" where Id=@Id ");
            SqlParameter[] parameters = {
					new SqlParameter("@KeyWords", SqlDbType.NVarChar,50),
					new SqlParameter("@SearchTimes", SqlDbType.Int,4),
        ...
        {
            string sql = "delete from KeyWordsRank";
        ...
        /// 得到一个对象实体
        /// </summary>
        public BookShop.Model.KeyWordsRank DataRowToModel(DataRow row)
        {
            BookShop.Model.KeyWordsRank model = new BookShop.Model.KeyWordsRank();
            if (row != null)
            {
        ...
        /// 获得数据列表
        /// </summary>
        public DataSet GetListLike(string keyWord)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select Id,KeyWords,SearchTimes ");
            strSql.Append(" FROM KeyWordsRank ");
            strSql.Append(" where KeyWords like @KeyWords");
            SqlParameter param = new SqlParameter("@KeyWords", keyWord + "%");
